...
\newcommand{\vvector}[3]{\begin{bmatrix}{#1}\\{#2}\\{#3}\end{bmatrix}}
\newcommand{\matx}[4]{\begin{bmatrix}{#1} & {#2}\\{#3}&{#4}\end{bmatrix}}
\newcommand{\detx}[4]{\begin{vmatrix}{#1} & {#2}\\{#3}&{#4}\end{vmatrix}}
\usepackage{setspace}
\usepackage{graphicx}
\usepackage{amsmath}
\usepackage{amssymb}
...
\fancyhead[LO]{Assignment 5 - MTH 307}
